...
function condividi(msg) {
    ...
    a2.style.cssText = "display: flex; flex-direction: rows; align-items: left;";
    a3.href="CondividiServlet?appCond='Instagram'";
    a3.style.cssText = "display: flex; flex-direction: rows; align-items: left;";
    a4.href="CondividiServlet?appCond='Telegram'";
    a4.style.cssText = "display: flex; flex-direction: rows; align-items: left;";
    a5.href="CondividiServlet?appCond='Whatsapp'";
    a5.style.cssText = "display: flex; flex-direction: rows; align-items: left;";
...
function messageInfo(idUtente,idPost) {
    ...
    a1.href="CommentiServlet?idUtente="+idUtente+"&idPost="+idPost+"&commentiNew="+commentoNew+"&paginaPost=altroUtente";
    a1.style.cssText = "display: flex; flex-direction: rows; align-items: left;";
    ...
    for(var i =0;i<array.length;i++){
        ...
        img.src="fotoUtente/"+arrayF[i]+".png";
    ...
    x.addEventListener("click", function(e,resp) {
    	  if(input.value!=""){
    		  var divElem = document.createElement('div');
    	        ...
    	        name.style.cssText = "font-family: Verdana, Helvetica, sans-serif; font-size: 12px; font-weight: bold; text-align:left; margin-top:2px;";
    	        name.innerHTML="Robero micione";
    	        img.src="icone/"+idUtente+".png";
    	        img.style.cssText ="width: 20px; height: 20px; border-radius: 50%; margin-top:2px;";
